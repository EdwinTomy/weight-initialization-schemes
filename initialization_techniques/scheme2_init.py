...
class WeightInitScheme2Params:
    def __init__(self, batch, verbose):
        self.batch = batch
        self.verbose = verbose


class WeightInitScheme2:
    ...
    def initialize(model, params):
        ...
        if verbose:
            print("------- Scheme 2 - Initialization Process Started ------- ")
        ...
        for i in range(len(model.layers)):
            ...
            if not isinstance(layer, classes_to_consider):
                if verbose:
                    print("Scheme2 - skipping " + layer.name + ' - not in the list of classes to be initialized')
                continue
            ...
            if verbose:
                ...
                print("------- Scheme 2 - Layer initialized: " + layer.name + " ------- ")
        ...
        if verbose:
            print("------- Scheme 2 - DONE - total layers initialized ", layers_initialized, "------- ")
