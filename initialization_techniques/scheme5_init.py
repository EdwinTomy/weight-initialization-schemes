...
class WeightInitScheme5Params:
    def __init__(self, batch, verbose):
        self.batch = batch
        self.verbose = verbose


class WeightInitScheme5:
    ...
    def initialize(model, params):
        ...
        if verbose:
            print("------- Scheme 5 - Initialization Process Started ------- ")
        ...
        for i in range(len(model.layers)):
            ...
            if not isinstance(layer, classes_to_consider):
                if verbose:
                    print("Scheme5 - skipping " + layer.name + ' - not in the list of classes to be initialized')
                continue
            ...
            if verbose:
                ...
                print("------- Scheme 5 - Layer initialized: " + layer.name + " ------- ")
        ...
        if verbose:
            print("------- Scheme 5 - DONE - total layers initialized ", layers_initialized, "------- ")
